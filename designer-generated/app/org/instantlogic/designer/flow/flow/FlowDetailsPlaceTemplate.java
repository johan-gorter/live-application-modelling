...
,                                new org.instantlogic.interaction.page.FragmentTemplate("F39P1F2P1F2P1S4F2", "Link")      .setEvent(org.instantlogic.designer.event.FlowNodeDetailsEvent.INSTANCE)
      
                                .putChildren("content",
                                        new org.instantlogic.interaction.page.FragmentTemplate("F39P1F2P1F2P1S4F2P1F1", "Block")      
                                        .putChildren("content",
                                                new org.instantlogic.interaction.page.FragmentTemplate("F39P1F2P1F2P1S4F2P1F1P1F1", "Strong")      
