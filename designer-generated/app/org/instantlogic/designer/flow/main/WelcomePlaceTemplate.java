...
public class WelcomePlaceTemplate extends org.instantlogic.interaction.flow.PlaceTemplate {
	...
	private static org.instantlogic.interaction.page.FragmentTemplate CONTENT = 
        new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1", "Page")      
        .putChildren("headerContent",
                new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P1F1", "Heading1")      
                .putText("text", new org.instantlogic.fabric.text.ConstantTextTemplate("Welcome"))
        )
      
        .putChildren("mainContent",
                new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P2F1", "Paragraph")      
                .putText("text", new org.instantlogic.fabric.text.ConstantTextTemplate("Welcome to the Designer"))
,
                new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P2F2", "Table")      
                .putChildren("columns",
                        new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P2F2P1F1", "Column")      
                        .putText("header", new org.instantlogic.fabric.text.ConstantTextTemplate("Entities"))
                )
      
                .putChildren("rows",
                        new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P2F2P2F1", "Row")      
                        .putChildren("cells",
                                new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P2F2P2F1P1F1", "Cell")      
                                .putChildren("content",
                                        new org.instantlogic.interaction.page.SelectionElement(createDeduction0()
,                                                new org.instantlogic.interaction.page.FragmentTemplate("F39P2F1P2F2P2F1P1F1P1S1F2", "Link")      .setEvent(org.instantlogic.designer.event.EntityDetailsEvent.INSTANCE)
