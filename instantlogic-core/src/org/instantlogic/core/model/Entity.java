...
public abstract class Entity<I extends Instance<I>> extends Concept {
	...
	public I createInstance(CaseInstance<?> caseInstance) {
		return createInstance(caseInstance, 0l);
	}

	public abstract I createInstance(CaseInstance<?> caseInstance, long id); //TODO: long id -> SerializedInstance<I>
