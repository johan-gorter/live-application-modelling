 ...
 */
public class Instantlogic implements EntryPoint {
	/**
...
//		jaar.autos.add(auto);
//		auto.initMaanden();
//		auto.getBeginstand().setKmStand(10100);
		
		addStand(2,2, "a", 10200);
		
		
		final Button sendButton = new Button("Send");
		final TextBox nameField = new TextBox();
//		nameField.setText(""+auto.getMaanden().get(1).getBeginstand().getKmStand());
