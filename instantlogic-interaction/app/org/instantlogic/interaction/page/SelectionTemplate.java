 ...
 */
public class SelectionTemplate extends AbstractTemplate {

	private final Deduction<?> selection;
	private final AbstractTemplate[] children;
	
	public SelectionTemplate(Deduction<?> selection, AbstractTemplate... children) {
	...
	private void renderWith(Object value, RenderContext context, List<Map<String, Object>> appendTo) {
		if (value instanceof Instance) {
			...
			for (AbstractTemplate template: children) {
