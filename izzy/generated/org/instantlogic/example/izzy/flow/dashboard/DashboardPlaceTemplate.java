...
public class DashboardPlaceTemplate extends org.instantlogic.interaction.flow.PlaceTemplate {
	...
	private static org.instantlogic.interaction.page.FragmentTemplate CONTENT = 
        ...
        .putChildren("mainContent",
                new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1", "Table")      
                .putChildren("columns",
                        new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P1F1", "Column"),
                        new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P1F2", "Column")      
...
,                                new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P2S1F2", "Row")      
                                .putChildren("cells",
                                        new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P2S1F2P1F1", "Link")      .setEvent(org.instantlogic.example.izzy.event.IssueDetailsEvent.INSTANCE)
      
                                        .putChildren("content",
                                                new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P2S1F2P1F1P1F1", "Cell")      
                                                .putChildren("content",
                                                        new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P2S1F2P1F1P1F1P1F1", "Paragraph")      
...
,
                                                new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P2S1F2P1F1P1F2", "Cell")      
                                                .putChildren("content",
                                                        new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F1P2S1F2P1F1P1F2P1F1", "Paragraph")      
...
,
                new org.instantlogic.interaction.page.FragmentTemplate("F13P1F1P1F2", "Button")      .setEvent(org.instantlogic.example.izzy.event.CreateIssueEvent.INSTANCE)
