...
public class IfElseDesignEntityGenerator extends EntityDesign {
    ...
    public static final RelationDesign ifChildren = addRelation(ENTITY, "ifChildren", RelationType.OneToManyAggregation, ElementDesignEntityGenerator.ENTITY);    

    public static final RelationDesign elseChildren = addRelation(ENTITY, "elseChildren", RelationType.OneToManyAggregation, ElementDesignEntityGenerator.ENTITY);    
}