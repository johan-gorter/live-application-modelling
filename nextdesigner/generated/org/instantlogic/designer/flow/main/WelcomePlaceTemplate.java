...
public class WelcomePlaceTemplate extends org.instantlogic.interaction.flow.PlaceTemplate {
	...
	private static org.instantlogic.interaction.page.FragmentTemplate CONTENT = 
        ...
        .putChildren("mainContent",
                new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1", "Block")      .setStyleNames(new String[]{"card"})
      
                .putChildren("content",
                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F1", "Heading1")      
...
,
                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F2", "Paragraph")      
...
,
                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F3", "Table")      
                        .putChildren("columns",
                                new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F3P1F1", "Column")      
...
,                                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F3P2S1F2", "Row")      
                                        .putChildren("cells",
                                                new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F3P2S1F2P1F1", "Cell")      
                                                .putChildren("content",
                                                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F3P2S1F2P1F1P1F1", "Link")      .setEvent(org.instantlogic.designer.event.EntityDetailsEvent.INSTANCE)
...
,
                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F4", "Table")      
                        .putChildren("columns",
                                new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F4P1F1", "Column")      
...
,                                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F4P2S1F2", "Row")      
                                        .putChildren("cells",
                                                new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F4P2S1F2P1F1", "Cell")      
                                                .putChildren("content",
                                                        new org.instantlogic.interaction.page.FragmentTemplate("F20P2F1P1F1P1F4P2S1F2P1F1P1F1", "Link")      .setEvent(org.instantlogic.designer.event.FlowDetailsEvent.INSTANCE)
