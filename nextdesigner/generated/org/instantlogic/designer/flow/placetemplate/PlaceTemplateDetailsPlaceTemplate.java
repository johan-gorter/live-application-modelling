...
public class PlaceTemplateDetailsPlaceTemplate extends org.instantlogic.interaction.flow.PlaceTemplate {
	...
	@Override
	public String getId() {
		return "8ed17e6e-e59c-4109-b726-5a50dcd007b7";
	}
	...
	private static org.instantlogic.interaction.page.FragmentTemplate CONTENT = 
        new org.instantlogic.interaction.page.FragmentTemplate("443ed0af-557a-461e-ac2e-685cc984c81f", "Page")      
        .putChildren("mainContent",
                new org.instantlogic.interaction.page.SelectionElement(createDeduction0()
,                            new org.instantlogic.interaction.page.SharedElementHolder("e16e19e8-ddae-4c63-923b-05f00a80d4b1", org.instantlogic.designer.sharedpagefragment.FlowContextPageFragment.INSTANCE)
)
,
                new org.instantlogic.interaction.page.FragmentTemplate("96d5d78f-e263-4155-8704-bab23811085c", "Block")      .setStyleNames(new String[]{"card"})
      
                .putChildren("content",
                        new org.instantlogic.interaction.page.FragmentTemplate("0852d0ff-6308-4e3b-bc17-8cd48f0aa1f6", "Heading3")      
...
,
                        new org.instantlogic.interaction.page.FragmentTemplate("56c44370-6011-4528-808a-481fc723aff6", "Input")      .setField(org.instantlogic.designer.entity.DesignEntity.INSTANCE, org.instantlogic.designer.entity.DesignEntity.name)
,
                        new org.instantlogic.interaction.page.FragmentTemplate("15da4d6d-37c9-4e34-a132-fdc9c3d0fa9e", "Heading4")      
...
,                                new org.instantlogic.interaction.page.FragmentTemplate("71a2f21e-59f2-4e30-a73e-e1792c608606", "ElementEditor")      
                                .putChildren("content",
                                            new org.instantlogic.interaction.page.SharedElementHolder("24b812c5-e8f2-40ec-8dd2-b091e9390af6", org.instantlogic.designer.sharedpagefragment.ElementEditorPageFragment.INSTANCE)
                                )
)
                )
        )
